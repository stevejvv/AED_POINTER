		...
		geocoder.geocode( { 'address': sAddress}, function(results, status) {
	      if (status == google.maps.GeocoderStatus.OK) {
	          if(results[0])
	          {
				...
				//          streetNum = results[0].address_components[i].long_name;
				//    }
				//}
				...
				document.getElementById("addressResult0").innerHTML = "<br />Address: "+"<span>" + address +"</span><br /><br />Latitude: "+ coordsLat + "<br />Longitude: "+ coordsLng;
				...
				//document.getElementById("hiddenOutput").innerHTML += "<input type=\"hidden\"  id=\"streetNumCheck\" name=\"streetNum\"  value=\""+streetNum+"\">";
